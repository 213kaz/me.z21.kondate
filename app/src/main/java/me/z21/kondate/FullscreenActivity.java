...
//        binding.fullscreenContent.setOnTouchListener(mDelayHideTouchListener);
    ...
    private void showSetting() {
        Intent intent = new Intent(this, SettingsActivity.class); // 設定画面
    ...
    protected void setScreenOffTime(){
        ...
        //    Log.d(TAG,"画面をスリープする秒数" + intScreenOffTime);
        //}

        // Keep screen off
        getWindow().clearFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        Log.d(TAG,"画面をスリープにしない:解除");
    }
